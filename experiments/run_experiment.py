...
from experiments.experiment_configs import syn, chem, metabric, mnist
...
if __name__ == "__main__":
    ...
    folder = osp.join('results', args.experiment, args.model, 'run_'+str(args.experiment_no))
    ...
    for i in range(len(learnt_groups)):
        np.save(osp.join(folder, 'group_'+str(i+1)+'_feature_indices.npy'), learnt_groups[i])
